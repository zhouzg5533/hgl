<template>
	...
	>
		<view
			...
			:key="vk.pubfn.createOrderNo('B',32)"
 ...
 * 移植自uview1.0 个人感觉这种使用方式比2.0的更好用 ^_^
 ...
 * @property {String Number} border-radius b-skeleton-fillet类名元素，对应的骨架块的圆角大小，单位rpx（默认10）
 * @property {Boolean} loading 是否显示骨架组件，请求完成后，将此值设置为false（默认true）
 * @example <b-skeleton :loading="true" :animation="true"></b-skeleton>
 */
export default {
	name: 'b-skeleton',
	props: {
		...
		// 圆角值，只对类名为b-skeleton-fillet的元素生效，为数值，不带单位
		borderRadius: {
			type: [String, Number],
			default: '4'
		},
